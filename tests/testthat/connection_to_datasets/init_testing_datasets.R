...
init.testing.dataset.factor_levels.2 <- function()
{
  log.out.data.server()
  if (ds.test_env$secure_login_details)
  {
    ...
    if (ds.test_env$driver == "OpalDriver")
    {
      ds.test_env$server <- c("GROUP2")
      ds.test_env$url <- c(ds.test_env$ip_address_1)
      ds.test_env$user <- c(ds.test_env$user_1)
      ds.test_env$password <- c(ds.test_env$password_1)
      ds.test_env$table <- c("FACTOR_LEVELS.FACTOR_LEVELS2")
      ds.test_env$login.data <- datashield.build.login.data.frame.o(ds.test_env$server,
                                                                    ds.test_env$url,
                                                                    ds.test_env$table,
                                                                    ds.test_env$user,
...
init.testing.dataset.factor_levels.3 <- function()
{
  log.out.data.server()
  if (ds.test_env$secure_login_details)
  {
    ...
    if (ds.test_env$driver == "OpalDriver")
    {
      ds.test_env$server <- c("GROUP3")
      ds.test_env$url <- c(ds.test_env$ip_address_1)
      ds.test_env$user <- c(ds.test_env$user_1)
      ds.test_env$password <- c(ds.test_env$password_1)
      ds.test_env$table <- c("FACTOR_LEVELS.FACTOR_LEVELS3")
      ds.test_env$login.data <- datashield.build.login.data.frame.o(ds.test_env$server,
                                                                    ds.test_env$url,
                                                                    ds.test_env$table,
                                                                    ds.test_env$user,
...
connect.testing.dataset.factor_levels.2 <- function()
{
  log.out.data.server()
  source("connection_to_datasets/login_details.R")
  init.testing.dataset.factor_levels.2()
  log.in.data.server()
}

connect.testing.dataset.factor_levels.3 <- function()
{
  log.out.data.server()
  source("connection_to_datasets/login_details.R")
  init.testing.dataset.factor_levels.3()
  log.in.data.server()
}
...
disconnect.testing.dataset.factor_levels.2 <- function()
{
  log.out.data.server()
}

disconnect.testing.dataset.factor_levels.3 <- function()
{
  log.out.data.server()
}
